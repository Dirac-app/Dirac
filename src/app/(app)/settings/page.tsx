...
import type { ToneProfile, ToneContext } from "@/lib/store";
...
function ExportSection() {
  return (
    <section>
      ...
      <p className="text-xs text-muted-foreground/70 mb-4">
        Export threads from the thread view using the download button in the header toolbar.
        Threads can be saved as PDF, JSON, or MBOX.
      </p>
      <div className="space-y-3">
        <div className="rounded-lg border border-border p-4 space-y-3">
          <div className="flex items-center gap-3">
            <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-md bg-red-50 text-red-500 dark:bg-red-950 dark:text-red-400">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>
            </div>
            <div>
              <p className="text-sm font-medium text-foreground">PDF</p>
              <p className="text-xs text-muted-foreground">Formatted document, great for sharing or printing</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-md bg-blue-50 text-blue-500 dark:bg-blue-950 dark:text-blue-400">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/></svg>
            </div>
            <div>
              <p className="text-sm font-medium text-foreground">JSON</p>
              <p className="text-xs text-muted-foreground">Machine-readable format for backups or integrations</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-md bg-emerald-50 text-emerald-500 dark:bg-emerald-950 dark:text-emerald-400">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>
            </div>
            <div>
              <p className="text-sm font-medium text-foreground">MBOX</p>
              <p className="text-xs text-muted-foreground">Standard email format, import into any mail client</p>
            </div>
          </div>
        </div>
        <div className="rounded-lg border border-border/50 bg-muted/20 px-3 py-2.5">
          <p className="text-[11px] text-muted-foreground">
            <span className="font-medium text-foreground">How to export:</span> Open any thread, click the download icon
            in the thread header, and choose PDF, JSON, or MBOX.
  ...
  return (
    <div className="dirac-panel flex flex-1 flex-col overflow-hidden">
      ...
      >
        ...
        <div id="export"><ExportSection /></div>
